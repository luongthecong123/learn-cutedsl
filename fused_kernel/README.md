...
This technical write-up presents my solution to FlashInfer AI Kernel Generation Contest @ MLSys 2026. This solution got rank # 2 on Deepseek Sparse Attention [1] (DSA) track, with a speedup over Flashinfer wrapper of DeepGEMM and tensorRT_LLM is 29.5x, with DSA speedup of 22.05x.
