...
TMA_ROLE = 0
MMA_ROLE = 1
ROLE_NAMES = {TMA_ROLE: "TMA warp", MMA_ROLE: "MMA warp"}
...
class Gemm_TC:
    def __init__(
        ...
        self.threads_per_cta = (
            self.mma_warp_groups * self.num_threads_per_warp_group + self.warp_size * self.num_tma_warps
        )
    ...
    def kernel(
        ...
        tma_leader = self.mma_warp_groups * self.num_threads_per_warp_group
...
def main():
    ...
    k_tile_cnt = K // bK
    # TMA row: tma_load (k_tile_cnt) + tma_store (1)
    # MMA row: wgmma (k_tile_cnt) + frag_to_smem (1)
    max_entries_per_role = k_tile_cnt + 2  # +1 slack
